...
class dBOTVisionTransformer(VisionTransformer):
    """
...
def _create_dbot_vit(variant: str, pretrained: bool = False, **kwargs) -> dBOTVisionTransformer:
    ...
    if pretrained and variant.startswith("vit_base"):
        ...
        if (
            ...
            and checkpoint_model["pos_embed"] is not None
            and model.pos_embed is not None
        ):
        ...
        _trunc_normal_(model.head.weight, std=0.01)
...
@register_model
def vit_base_patch16_dbot_224(pretrained: bool = False, **kwargs) -> dBOTVisionTransformer:
    model_args = dict(
        patch_size=16,
        embed_dim=768,
        depth=12,
